  ...
  return (
    <AlertDialog.Root>
      <AlertDialog.Trigger asChild>
        <button className="flex justify-center text-nowrap rounded-xl bg-gradient-to-r from-red-500 to-red-600 px-3 py-2 text-sm font-semibold text-white transition hover:scale-[1.02] hover:bg-red-600">

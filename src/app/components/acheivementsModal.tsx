  ...
  return (
    <div className="absolute z-50">
      ...
      <Dialog.Root open={achievements} onOpenChange={setAchievements}>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-[90vw] max-w-3xl -translate-x-1/2 -translate-y-1/2 overflow-scroll rounded-2xl bg-orange-300 p-6 shadow-lg">

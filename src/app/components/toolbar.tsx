  ...
  return (
    <>
      <Flex
        align="center"
        justify="center"
        className="fixed bottom-[0.5rem] left-[calc(50%-12.35rem)] z-30 m-4 gap-2 rounded-xl border border-orange-500 bg-orange-400/95 p-2 sm:left-2 sm:top-[calc(100vh-6rem)]"
      >
        {/* <PawPrintIcon
          // src="/images/prox.svg"
          // alt="Prox"
        ...
        <Flex className="w-[7.5rem]">
          ...
          >
            ...
            <img
              ...
              className="z-5 absolute h-20 w-20"
            />
            ...
            <Link
              ...
              className="z-5 absolute bottom-[-0.35rem] right-[-2.5rem] truncate rounded-r-lg border border-orange-700 bg-orange-500 px-2 py-2 text-sm font-semibold no-underline transition hover:bg-orange-300"
            >
              {session ? (
        ...
        <Tooltip content="GitHub Repository">
          <a
            ...
            className="hidden rounded-lg border border-orange-500 bg-orange-300 px-2.5 py-2 text-gray-700 hover:scale-[1.02] hover:bg-orange-200 sm:flex"
          >
            <GithubIcon size={24} />
          </a>
        </Tooltip>
